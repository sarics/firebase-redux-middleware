...
var addIdToActionData_addIdToActionData = function addIdToActionData(action, data, id) {
  ...
  return Object.keys(action).reduce(function (newAction, key) {
    ...
    } else if (!found && actionData != null && (typeof actionData === 'undefined' ? 'undefined' : addIdToActionData__typeof(actionData)) === 'object') {
    ...
    return addIdToActionData__extends({}, newAction, _defineProperty({}, key, newActionData || actionData));
